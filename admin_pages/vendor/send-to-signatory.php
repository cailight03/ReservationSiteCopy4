...
$insertQuery = "INSERT INTO reservations (date_submitted, department, requestor,speakerName, organization, userType, activityType, activity_name, date, time_slot, room_id, room_name, items_needed, remarks, status, num_of_attendees)
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'pending', ?)";

$stmt = $connection->prepare($insertQuery);
$stmt->bind_param("ssssssssssssssi",$submissionTime,$college, $fullName, $speakerName, $organization, $userType, $activityType, $activityName, $date, $timeSlot, $roomId, $roomName, $selectedItemsJSON, $remarks, $numOfAttendees);

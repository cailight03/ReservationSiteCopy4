...
<head>
    ...
    <title>NULR Admin | Room Management Logs</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                        <h2 class="grid-header" id="header">Room Management Logs</h2>

                        <!-- Table to display reservations -->
                        <table id="roomManagementLogs" class="table table-hover table-bordered">
                            <thead>
                                <tr>
                                    <th>Audit ID</th>
                                    <th>Room ID</th>
                            ...
                            <tbody>
                                ...
                                $query = "SELECT * FROM reservationdb.room_audit ORDER BY timestamp DESC;";

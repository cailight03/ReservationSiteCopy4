...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $updateQuery = "UPDATE reservations SET Sig3 = ?, Act3 = 'Approved', time3 = NOW()  WHERE id = ?";
...
if (isset($query)) {
    ...
    //Approve details
    $approveLink = 'http://localhost/ReservationSiteCopy4/super_admin_pages/approve_page4.php';

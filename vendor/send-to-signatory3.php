...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $updateQuery = "UPDATE reservations SET Sig2 = ?, Act2 = 'Approved', time2 = NOW()  WHERE id = ?";
...
if (isset($query)) {
    ...
    //Approve details
    $approveLink = 'http://localhost/ReservationSiteCopy4/super_admin_pages/approve_page3.php';
